...
const ingredients = [
  { name: "arroz integral",           category: "grão",        allergenGroup: null },
  { name: "lentilha",                 category: "leguminosa",  allergenGroup: null },
  { name: "feijão preto",             category: "leguminosa",  allergenGroup: null },
  { name: "grão-de-bico",             category: "leguminosa",  allergenGroup: null },
  { name: "quinoa",                   category: "grão",        allergenGroup: null },
  { name: "batata-doce",              category: "tubérculo",   allergenGroup: null },
  { name: "batata",                   category: "tubérculo",   allergenGroup: null },
  { name: "cenoura",                  category: "legume",      allergenGroup: null },
  { name: "cebola",                   category: "tempero",     allergenGroup: null },
  { name: "alho",                     category: "tempero",     allergenGroup: null },
  { name: "tomate",                   category: "legume",      allergenGroup: null },
  { name: "espinafre",                category: "folha",       allergenGroup: null },
  { name: "couve",                    category: "folha",       allergenGroup: null },
  { name: "brócolis",                 category: "vegetal",     allergenGroup: null },
  { name: "abobrinha",                category: "legume",      allergenGroup: null },
  { name: "cogumelo",                 category: "fungo",       allergenGroup: null },
  { name: "amendoim",                 category: "oleaginosa",  allergenGroup: "amendoim" },
  { name: "castanha-de-caju",         category: "oleaginosa",  allergenGroup: "oleaginosas" },
  { name: "amêndoa",                  category: "oleaginosa",  allergenGroup: "oleaginosas" },
  { name: "leite de coco",            category: "líquido",     allergenGroup: null },
  { name: "tofu",                     category: "proteína",    allergenGroup: "soja" },
  { name: "tempeh",                   category: "proteína",    allergenGroup: "soja" },
  { name: "aveia",                    category: "cereal",      allergenGroup: "glúten" },
  { name: "farinha de trigo integral",category: "farinha",     allergenGroup: "glúten" },
  { name: "banana",                   category: "fruta",       allergenGroup: null },
  { name: "maçã",                     category: "fruta",       allergenGroup: null },
  { name: "manga",                    category: "fruta",       allergenGroup: null },
  { name: "cúrcuma",                  category: "tempero",     allergenGroup: null },
  { name: "gengibre",                 category: "tempero",     allergenGroup: null },
  { name: "azeite",                   category: "gordura",     allergenGroup: null },
];
...
async function main() {
  ...
  for (const ing of ingredients) {
    await prisma.ingredient.upsert({
      where: { name: ing.name },
      update: { category: ing.category, allergenGroup: ing.allergenGroup },
      create: ing,
    });
  }
